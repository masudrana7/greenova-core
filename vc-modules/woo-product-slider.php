...
if ( !class_exists( 'GREENOVA_Theme_VC_Product_Slider' ) ) {
		
	class GREENOVA_Theme_VC_Product_Slider extends GREENOVA_Theme_VC_Modules {

		public function __construct(){
			$this->name = __( "Greenova: Product Slider", 'greenova-core' );
			$this->base = 'greenova-vc-top-deal-slider';
			$this->translate = array(
				'title'    => __( "Our Best Deals", 'greenova-core' ),
				'cols' => array( 
		...
		public function fields(){
			...
			$fields = array(
				array(
					...
					"param_name" => "display_prod_based",
					'value' => array(
						__( "All Sale Product", 'greenova-core' )  => 'sale',
						__( "Feature Product", 'greenova-core' )  => 'feature',
						__( "Category Wise", 'greenova-core' )  => 'category',
						__( "Product Wise", 'greenova-core' )  => 'product',
						__( "All", 'greenova-core' )  => 'all',
						),
					),
				array(
					"type" => "dropdown",
		...
		public function shortcode( $atts, $content = '' ){
			...
			switch ( $display_prod_based ) {
				case 'all':
					$template = 'woo-all-product-slider';
				break;
				case 'product':
					$template = 'woo-product-wise-slider';
				break;
				case 'category':
					$template = 'woo-category-product-slider';
				break;
				case 'feature':
					$template = 'woo-feature-product-slider';
				break;
				default:
					$template = 'woo-sale-product-slider';					
				break;
			}
...
new GREENOVA_Theme_VC_Product_Slider;