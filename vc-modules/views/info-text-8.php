...
<div class="rt-info-text-8">
	<div class="service-box" data-icon-hv-color="<?php echo esc_attr( $icon_hov_color ); ?>" data-title-hv-color="<?php echo esc_attr( $title_hover_color ); ?>" data-title-color="<?php echo esc_attr( $title_color ); ?>">
