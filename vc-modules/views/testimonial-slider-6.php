...
?>
<div class="rt-testimonial-slider-6 owl-wrap rt-owl-nav-3 <?php echo esc_attr( $slider_nav_class );?><?php echo esc_attr( $slider_dot_class );?>">
	<div class="row">
		...
		<?php if ( $query->have_posts() ) { ?>
			...
			?>
			<div class="single-item col-sm-6 col-xs-12">
