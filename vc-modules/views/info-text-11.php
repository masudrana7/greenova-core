...
if ( empty($color) ) {
	$new_color = GREENOVA_Theme::$options['primary_color'];
} else {
	$new_color = $color;
}
if ( empty($bgcolor)) {
...
?>
<div class="rt-info-text-11" data-color="<?php echo esc_attr( $color );?>" data-hover="<?php echo esc_attr( $hovercolor );?>" data-title-color="<?php echo esc_attr( $title_color );?>" data-title-hover="<?php echo esc_attr( $title_hover_color );?>" data-bghovercolor="<?php echo esc_attr( $icon_bg_color );?>">
	<div class="service-box" style="background:<?php echo esc_attr( $new_bg ); ?>">
		<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
			...
			fill="<?php echo esc_attr( $new_bg ); ?>" stroke="none">
		...
		<?php } else { ?>
			<span><i style="color:<?php echo esc_attr($new_color); ?>;<?php echo esc_attr($icon_css); ?>" class="<?php echo esc_attr( $icon ); ?>" aria-hidden="true"></i></span>
		<?php } ?>
		<h3 style="color:<?php echo esc_attr( $title_color_fon ); ?>"><?php echo wp_kses_post( $heading ); ?></h3>
		<p><?php echo wp_kses_post( $content );  ?></p>
		<?php if ( !empty( $button_url ) ) { ?>		
		<a class="white-button" href="<?php echo esc_url( $button_url ); ?>"><?php echo wp_kses_post( $button_text ); ?></a>
		<?php } ?>
	</div>
</div>
