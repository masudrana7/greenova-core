...
$slider_nav_class = ( $slider_nav == 'false' ) ? '' : ' slider-nav-enabled';
?>
<div class="rt-team-slider-nine owl-wrap rt-owl-nav-3 <?php echo esc_attr( $slider_dot_class );?><?php echo esc_attr( $slider_nav_class );?>">
	...
	<?php if ( $query->have_posts() )  { ?>
		...
		?>
		<div class="team-box team2-area">
			<div class="team-box-top">
				<ul class="team-social item-social">
