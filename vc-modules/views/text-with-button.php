...
<div class="<?php echo esc_attr( $custom_class );?> <?php echo esc_attr( $tab_layout );?>" style="<?php echo esc_attr( $section_css );?>">
	<div class="rt-text-with-btn">
		...
		<?php if ( !empty( $content_text ) ) { ?>
			<<?php echo esc_html( $title_tag ); ?> style="<?php echo esc_attr( $title_css ); ?>"><?php echo esc_html( rawurldecode( base64_decode( wp_strip_all_tags( $content_text ) ) ) );?></<?php echo esc_html( $title_tag ); ?>>
		<?php } ?>
