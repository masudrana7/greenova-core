...
?>
<div class="rt-team-slider-ten owl-wrap owl-wrap rt-owl-nav-1<?php echo esc_attr( $slider_nav_class );?><?php echo esc_attr( $slider_dot_class );?>">
			...
			<?php
				...
				if ( has_post_thumbnail() ){
					...
					elseif ( !empty( GREENOVA_Theme::$options['no_preview_image']['url'] ) ) {
						$thumbnail = '<img class="attachment-greenova-size5 size-greenova-size5 wp-post-image" src="'.GREENOVA_IMG_URL.'noimage_290X270.jpg" alt="'.get_the_title().'">';
					}
				}
			?>
