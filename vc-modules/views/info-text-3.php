...
?>
<div class="<?php echo esc_attr ( $show_icon_bord ); ?> <?php echo esc_attr( $class );?> <?php if ( $icontype == 'flaticon' ) { ?>flaticon <?php } ?> rt-info-text-3" data-color="<?php echo esc_attr( $color );?>" data-title-color="<?php echo esc_attr( $title_color );?>" data-title-hover="<?php echo esc_attr( $title_hover_color );?>" data-bghovercolor="<?php echo esc_attr( $icon_bg_color );?>">
