...
<div class="rt-cta-4 footer-topbar">
	<div class="row">
		<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
			<div class="emergrncy-img-holder" style="background-image: url(<?php if ( !empty ( $image )) { echo wp_get_attachment_url( $image ); } else { ?><?php echo plugins_url( '/assets/footertopbar-img.jpg', dirname(__FILE__) ); ?><?php } ?>);"></div>
		</div>
