...
?>
<div class="rt-post-vc-section-7 owl-wrap rt-owl-nav-3 rt-latest-article-section <?php echo esc_attr( $slider_dots_class );?>">	
		...
		<?php while ( $query->have_posts() ) : $query->the_post();?>
			...
			<div class="rtin-single-post">
				...
				<div class="rtin-item-info">
					...
					<a class="light-button" href="<?php the_permalink(); ?>"><?php esc_html_e( 'Read More' , 'greenova-core' ); ?><i class="fa fa-angle-right"></i></a>
				</div>
			</div>			
		<?php endwhile;?>
	<?php } else { ?>
