...
$wp_query   = $query;
?>
<div class="rt-project-gallery-9">
	...
	<?php if ( $query->have_posts() ) { ?>
		...
		?>			
			<div class="project9-box <?php echo esc_attr( $col_class );?> <?php echo esc_html( $term_list ); ?>">
				<div class="rt-portfolio-item">
					...
					<div class="rt-content">
						<div class="rt-content-holder">								
							...
							<a class="grid9-btn" href="<?php the_permalink(); ?>"><?php esc_html_e( 'Read More' , 'greenova-core' ); ?></a>
						</div>
					</div>
				</div>
			</div>
