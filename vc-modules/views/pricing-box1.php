...
$bghover_cl = $bghover ? $bghover : $primary_color_op;
$price_html  = $price;
$price_html .= !empty( $unit ) ? " <br><div class='price-unit'>/ $unit</div>": '';
?>
<div class="<?php echo esc_attr( $custom_class );?>">
	<div class="rt-price-table-box1 vc-elem" style="<?php echo esc_attr( $style );?>" data-bgcolor="<?php echo esc_attr( $bgcolor );?>" data-bghover="<?php echo esc_attr( $bghover_cl );?>">
