			...
			<div class="rtin-single-team">
				...
				<div class="rtin-item-content media-body">
					...
					<?php foreach ( $team_socials as $fin_team_social_key => $fin_team_social_value ) { ?>
						...
						<li><a target="_blank" href="<?php echo esc_attr( $fin_team_social_value );?>"><i class="fab <?php echo esc_attr( GREENOVA_Theme::$team_social_fields[$fin_team_social_key]['icon'] );?>"></i></a></li>
						<?php } ?>
					<?php } ?>
					</ul>
					<?php } ?>
