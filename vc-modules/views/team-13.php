...
$slider_nav_class = ( $slider_nav == 'true' ) ? ' slider-nav-enabled' : ' slider-dot-enabled';
?>
<div class="rt-team-slider-13 owl-wrap rt-owl-nav-1 owl-wrap<?php echo esc_attr( $slider_nav_class );?>">
			...
			<div class="rtin-single-team">
				...
				<div class="rtin-item-content">
					...
					<?php if ( $designation_display == 'true' ){ ?>
						<span class="position"><?php echo wp_kses_post( $team_designation ); ?></span>
					<?php } ?>
