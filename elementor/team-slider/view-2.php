...
$thumb_size = ( $data['thumbnail_size'] ? $data['thumbnail_size'] : 'greenova-size12' );
$args       = [
...
?>
<div class="rt-owl-carousel-wrapper rt-team-slider-ten owl-wrap owl-wrap rt-owl-nav-1<?php echo esc_attr( $slider_nav_class ); ?><?php echo esc_attr( $slider_dot_class ); ?>">
