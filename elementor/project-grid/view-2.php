...
?>
<div class="our-projects2-area rt-project-gallery-10 rt-project-grid-wrapper <?php echo esc_attr( $data['title_two_position'] ); ?>">
			...
			<?php while ( $query->have_posts() ) : $query->the_post();
				...
				if ( has_post_thumbnail() ) {
					...
					if ( ! empty( \GREENOVA_Theme::$options['no_preview_image']['id'] ) ) {
						...
						$thumbnail = '<img class="attachment-greenova-size5 size-greenova-size5 wp-post-image" src="' . GREENOVA_IMG_URL . 'noimage_900X600.jpg" alt="'
						             . get_the_title() . '">';
					}
				}
				?>

                <div class="<?php echo esc_attr( $col_class ); ?> project10-box">
                        ...
                        <div class="rtin-proj10-box-info project-content-wrapper">
                            <div class="content-wrap">
								...
								<?php if ( 'visible' == $data['readmore_visibility'] ) : ?>
                                    <a class="grid10-btn read-more-btn" href="<?php the_permalink(); ?>"><?php echo esc_html( $data['readmore_text'] ); ?></a>
								<?php endif; ?>
                            </div>
                        </div>
                    </div>
