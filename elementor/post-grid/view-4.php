...
?>
<div class="rt-post-vc-grid-4 rt-article-grid-wrapper">
    <div class="row">
				...
				if ( has_post_thumbnail() ) {
					...
					if ( ! empty( \GREENOVA_Theme::$options['no_preview_image']['url'] ) ) {
						$thumbnail = '<img class="img-responsive attachment-greenova-size5 size-greenova-size5 wp-post-image" src="' . GREENOVA_IMG_URL
						             . 'noimage_900X700.jpg" alt="' . get_the_title() . '">';
					}
				}
                ...
                <div class="<?php echo esc_attr( $col_class ); ?>">
                    <div class="rtin-single-post">
                        ...
                        <div class="rtin-item-info">
	                        <?php
				                if ( $data['cat_visibility'] ) :
                                $cetegories = get_the_category();
                                if ( ! empty( $cetegories ) ) {
                                    echo '<div class="rtin-item-category">
                                            <a href="' . esc_url( get_category_link( $cetegories[0]->term_id ) ) . '">
                                                ' . esc_html( $cetegories[0]->name ) . '
                                            </a>
                                        </div>';
                                }
				                endif;
