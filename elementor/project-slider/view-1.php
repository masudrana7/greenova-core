...
$thumb_size = $data['thumbnail_size'] ? $data['thumbnail_size'] : 'greenova-size7';
...
?>
<div class="rt-owl-carousel-wrapper rt-project-slider-one owl-wrap rt-owl-nav-3 rt-owl-nav-middle <?php echo esc_attr( $slider_dot_class ); ?><?php echo esc_attr( $slider_nav_class ); ?>">
