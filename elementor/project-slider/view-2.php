...
$thumb_size = $data['thumbnail_size'] ? $data['thumbnail_size'] : 'greenova-size2';
$args       = [
...
?>
<div class="rt-owl-carousel-wrapper rt-project-slider-two owl-wrap rt-owl-nav-3 rt-owl-nav-middle <?php echo esc_attr( $slider_dot_class ); ?><?php echo esc_attr( $slider_nav_class ); ?>">
    <div class="owl-theme owl-carousel rt-owl-carousel" data-carousel-options="<?php echo esc_attr( $owl_data ); ?>">
		<?php if ( $query->have_posts() ) { ?>
			<?php while ( $query->have_posts() ) : $query->the_post(); ?>
				...
				?>
                <div class="our-projects-box2 project-box-inner">
