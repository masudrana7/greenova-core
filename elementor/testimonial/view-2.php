...
?>
<div class="rt-owl-carousel-wrapper rt-testimonial-slider-1 owl-wrap rt-owl-nav-5 <?php echo esc_attr( $slider_nav_class ); ?><?php echo esc_attr( $slider_dot_class ); ?>">
    <div class="row">
        <div class="box-width owl-theme owl-carousel rt-owl-carousel <?php echo esc_html( $slider_col ) ?>" data-carousel-options="<?php echo esc_attr( $owl_data ); ?>">
                    ...
                    <div class="single-item col-xs-12">
                        <div class="single-item-wrapper">
                            <div class="tlp-tm-content-wrapper">
                                <div class="item-content content-wrapper"><?php echo esc_html( $content ); ?></div>
