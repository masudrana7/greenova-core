...
?>
<div>
    <div class="row auto-clear rt-service-grid-1 rt-service-wrapper <?php echo esc_attr( $data['box_text_align'] ) ?>">
		<?php if ( have_posts() ) { ?>
			<?php while ( have_posts() ) : the_post(); ?>
                ...
                <div class="service-box <?php echo esc_attr( $col_class ); ?>">
                    ...
                    <div class="service-content-holder">
						<?php if ( $showlink ) { ?>
                            <h3 class="title-bar50 title-1"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
						<?php } else { ?>
                            <h3 class="title-bar50 title-1"><?php the_title(); ?></h3>
						<?php } ?>
