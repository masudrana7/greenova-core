...
?>
<div class="row auto-clear rt-service-grid-2 rt-service-wrapper <?php echo esc_attr( $data['box_text_align'] ) ?>">
	<?php if ( have_posts() ) { ?>
		<?php while ( have_posts() ) : the_post(); ?>
            ...
            <div class="service-box <?php echo esc_attr( $col_class ); ?>">
                <div class="service-img-holder box-radius">
                    <div class="service-content-holder">
                        <h3 class="title-2 title-1"><?php the_title(); ?></h3>
                    </div>
					<?php /*if ( $showlink ) { ?>
			...
			<?php } else { */ ?>
					...
					<?php /* } */ ?>
                    <div class="service-hover-content-holder">
						<?php if ( $showlink ) { ?>
                            <h3 class="title-bar35 title-1"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
						<?php } else { ?>
                            <h3 class="title-bar35 title-1"><?php the_title(); ?></h3>
						<?php } ?>
