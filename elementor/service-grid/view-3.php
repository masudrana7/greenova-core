...
$shadow              = 'shadow';
?>
<div class="row auto-clear rt-service-grid-3 rt-service-wrapper <?php echo esc_attr( $shadow . ' ' . $data['box_text_align'] ); ?> ">
		...
		<?php while ( $query->have_posts() ) : $query->the_post(); ?>
            ...
            <div class="service-box <?php echo esc_attr( $col_class ); ?>">
                <div class="rtin-single-post">
                    <div class="rtin-item-image box-radius">
                        <a href="<?php the_permalink(); ?>">
							<?php echo wp_kses_post( $thumbnail ); ?>
                        </a>
                        <a class="plus-icon" href="<?php the_permalink(); ?>"><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
