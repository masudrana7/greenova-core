...
<div class="rt-owl-carousel-wrapper team-grid-wrapper rt-team-slider-three">
    <!-- rt-owl-carousel -->
    <div class="row">
		<?php if ( have_posts() ) { ?>
			<?php while ( have_posts() ) : the_post(); ?>
				...
				?>
                <div class="rtin-team-box <?php echo esc_attr( $col_class ); ?> team-grid-item">
                    <div class="rtin-single-team">

                        <div class="rtin-item-image team-img-wrapper"><a href="<?php the_permalink(); ?>"><?php echo wp_kses_post( $thumbnail ); ?></a></div>

                        <div class="rtin-item-content team-content-wrapper">
                            <h3><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>

							<?php if ( 'visible' == $data['designation_visibility'] ) { ?>
                                <span class="position designation"><?php echo esc_html( $team_designation ); ?></span>
							<?php } ?>
