...
?>
<div class="rt-post-vc-section-8 rt-owl-carousel-wrapper owl-wrap rt-owl-nav-1 rt-latest-article-section <?php echo esc_attr( $slider_dots_class . $slider_nav_class . $has_sec_title ); ?>">
				...
				if ( has_post_thumbnail() ) {
					...
					if ( ! empty( \GREENOVA_Theme::$options['no_preview_image']['url'] ) ) {
						$thumbnail = '<img class="img-responsive attachment-greenova-size5 size-greenova-size5 wp-post-image" src="' . GREENOVA_IMG_URL
						             . 'noimage_870X429.jpg" alt="' . get_the_title() . '">';
					}
				}
                ...
                <div class="rtin-single-post post-wrap-bg">
                    ...
                    <div class="rtin-item-info post-inner-paddnig">
						<?php if ( $data['date_visibility'] ) : ?>
                            <span class="date post-meta"><i class="fa fa-calendar" aria-hidden="true"></i><?php echo get_the_date(); ?></span>
						<?php endif; ?>
						...
						<?php if ( $data['author_visibility'] ) : ?>
                            <span class="by-author post-meta"><i class="fa fa-user-circle" aria-hidden="true"></i><span><?php esc_html_e( 'By', 'greenova-core' ); ?> <?php the_author_posts_link(); ?></span></span>
						<?php endif; ?>
