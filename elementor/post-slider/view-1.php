...
$thumb_size = $data['project_thumbnail_size'] ? $data['project_thumbnail_size'] : 'greenova-size7';
$args       = [
	'post_type'           => 'post',
...
?>
<div class="rt-post-vc-section-1 rt-owl-nav-middle rt-owl-carousel-wrapper owl-wrap rt-owl-nav-3 rt-latest-article-section <?php echo esc_attr( $slider_dots_class . $slider_nav_class . $has_sec_title ); ?>">
