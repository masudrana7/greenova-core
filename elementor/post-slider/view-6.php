...
$thumb_size = $data['project_thumbnail_size'] ? $data['project_thumbnail_size'] : 'greenova-size11';
$args       = [
	'post_type'           => 'post',
...
<div class="rt-post-vc-section-7 rt-owl-nav-middle rt-owl-carousel-wrapper owl-wrap rt-owl-nav-3 rt-latest-article-section <?php echo esc_attr( $slider_dots_class . $slider_nav_class . $has_sec_title ); ?>">
                ...
                <div class="rtin-single-post post-wrap-bg">
                    <div class="rtin-item-image">
						...
						<?php if ( $data['date_visibility'] ) : ?>
                            <span class="date date-wrapper"><?php echo get_the_date(); ?></span>
						<?php endif; ?>
                    </div>
