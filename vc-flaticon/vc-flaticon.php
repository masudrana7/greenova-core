...
if ( ! defined( 'RT_VC_FLATICON_VERSION' ) ) {
	define( 'RT_VC_FLATICON_VERSION',  GREENOVA_CORE );
}
...
function rt_register_flaticons(){
	...
	wp_register_style( 'rt-flaticon-green',   RT_VC_FLATICON_ASSETS . 'flaticon-green.min.css', array(), RT_VC_FLATICON_VERSION );
	wp_register_style( 'rt-flaticon-green-2', RT_VC_FLATICON_ASSETS . 'flaticon-green-2.min.css', array(), RT_VC_FLATICON_VERSION );
	...
	wp_enqueue_style( 'rt-flaticon-green' );
	wp_enqueue_style( 'rt-flaticon-green-2' );
...
function rt_flaticons_array( $icons ) {
	...
	require 'flaticon-green.php';
	require 'flaticon-green-2.php';
	require 'flaticon-finance.php';
	require 'flaticon-custom.php';
	$flaticons = array(
		__( 'Greenova', 'greenova-core' )      => $flaticons_green,
		__( 'Greenova-2', 'greenova-core' )    => $flaticons_green_2,
		__( 'Finance', 'greenova-core' )        => $flaticons_finance,
		__( 'Marketing', 'greenova-core' )      => $flaticons_sam,
		__( 'Miscellaneous', 'greenova-core' )  => $flaticons_custom,
	);
